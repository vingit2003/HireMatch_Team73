                    ...
                    <div className='mt-4'>
                      {
                        isLoading ? (
                          ...
                          type='submit'
                          containerStyles='inline-flex justify-center rounded-md border border-transparent bg-[#074742] px-8 py-2 text-sm font-medium text-white hover:bg-black hover:text-white focus:outline-none'
                          title={"Update"}
                        />
                        )}
                    </div>
      ...
      <div className=''>
              ...
              <div className='flex items-center justify-center py-5 md:py-0 gap-4'>
                <Link to='/upload-job'>
                  <CustomButton
                    title='Upload Job'
                    iconRight={<FiUpload />}
                    containerStyles={`text-[#01332f] py-1.5 px-3 md:px-5 focus:outline-none rounded text-sm md:text-base border border-[#01332f] w-32 h-16`}
                  />
                </Link>
                <CustomButton
                title="Update Details"
                  ...
                  iconRight={<FiEdit3 />}
                  containerStyles='py-1.5 px-3 md:px-5 focus:outline-none bg-[#01332f] hover:bg-[#005b54] text-white rounded text-sm md:text-base w-32 h-16 justify-center'
                />
              </div>
            )}
        </div>
        <p className="mt-5">Your information:</p>
        <div className='w-full flex flex-col md:flex-row justify-start md:justify-between mt-4 md:mt-8 text-sm'>
          ...
          <div className='flex flex-col items-center mt-10 md:mt-0'>
            ...
            <p className='text-[#01332f]'>Job Posts</p>
          </div>
        </div>
      </div>
